---
source: https://github.com/backstage/backstage/blob/master/docs/overview/architecture-overview.md
---
...
![ui and tech radar plugin connected together](./assets/backstage-archi-2.png)
...
![lighthouse plugin backend to microservice and database](./assets/backstage-archi-3.png)
...
![Package architecture](./assets/backstage-archi-4.png)
...
![Package decision](./assets/backstage-archi-5.png)
